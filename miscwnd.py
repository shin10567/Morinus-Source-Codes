...
class MiscWnd(commonwnd.CommonWnd):
	...
	def __init__(self, parent, chrt, options, mainfr, id = -1, size = wx.DefaultSize):
		...
		self.WIDTH = int(commonwnd.CommonWnd.BORDER+self.TABLE_WIDTH2+commonwnd.CommonWnd.BORDER)
		self.HEIGHT = int(commonwnd.CommonWnd.BORDER+self.TABLE_HEIGHT+self.TABLE2_OFFS+self.TABLE_HEIGHT2+commonwnd.CommonWnd.BORDER)
