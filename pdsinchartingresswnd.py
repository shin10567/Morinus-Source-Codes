...
#		self.Refresh()
    ...
    def drawBkg(self):
        ...
        size_tuple = (int(sz.GetWidth()), int(sz.GetHeight()))
        gchart = graphchartpds.GraphChartPDs(self.chartRadix, self.chartPDs, self.chartIngress, size_tuple, self.options, self.bw)
        # 아랫줄
        bmp = gchart.getBitmap()
