...
class HoursWnd(commonwnd.CommonWnd):
    ...
    def drawBkg(self):
        ...
        txt = mtexts.txts['TimeofBirth']+": " + str(hh).zfill(2)+':'+str(mm).zfill(2)+':'+str(ss).zfill(2)
        ...
        if self.chart.time.ph != None:
            ...
            if self.chart.time.ph.daytime:
                txt1 = mtexts.txts['RiseTime']+": " + str(rh).zfill(2)+':'+str(rm).zfill(2)+':'+str(rs).zfill(2)
                txt2 = mtexts.txts['SetTime']+": "  + str(sh).zfill(2)+':'+str(sm).zfill(2)+':'+str(ss).zfill(2)
            else:
                txt1 = mtexts.txts['RiseTime']+": " + str(rh).zfill(2)+':'+str(rm).zfill(2)+':'+str(rs).zfill(2)
                txt2 = mtexts.txts['SetTime']+": "  + str(sh).zfill(2)+':'+str(sm).zfill(2)+':'+str(ss).zfill(2)
